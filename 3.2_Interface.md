...
[Iterator](https://www.simplilearn.com/tutorials/java-tutorial/iterator-in-java) gives you a sequence of elements from a data structure, without you having to worry about
whether the data structure is a set or a hash table or a list or an array — the Iterator looks the
same no matter what the data structure is. Iterator gives us a unified way to loop over any data.
