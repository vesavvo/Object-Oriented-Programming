...
The only real ouptut of the application is the first and last name of the employee. The rest of the output is generated by Hibernate. The output shows that the database table is created, and the two employees are persisted to the database.
