...
statement and executes it. The result of the query is returned as an object of the `Employee` class. The `find` method takes two arguments: the runtime class of the object and the identifier value of the object. The method automatically construct the object and returns it.
