...
1. Choose the index for the first name randomly.
2. Choose the index for the last name randomly.
3. Combine the randomly chosen first name and last name to form a new name.
4. Print the generated name.
