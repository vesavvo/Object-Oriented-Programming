...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <center><img src="images/BWAbstraction.png"><br></center>Part of the real-world properties (color) are abstracted out. We are able to concentrate to the main properties, and not distracted on irrelevant properties. | <center><img src="images/COLAbstraction.png"><br></center>Describes all properties. Of course we loose some information here. In this case the feeling of the place is mostly lost when you look the black and white picture only. | 
