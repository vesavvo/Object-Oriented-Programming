...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <center><img src="images/BWAbstraction.png"></center><br>Part of the real-world properties (color) are abstracted out. We are able to consentrate to the main properties, and not distracted on irrelevant properties. | <center><img src="images/COLAbstraction.png"></center><br>Describes all properties. Of course we loose some information here. In this case the feeling of the place is mostly lost when you look the black and white picture only. | 
<p align="center" width="100%">
    <img width="20%" src="images/AbstractArt.png"><br>
