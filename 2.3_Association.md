...
Variables whose type is a primitive type hold the real value of the variable. Whereas, variables whose type is a class hold a reference to the value of the variable (You can think of this being just like a C pointer, but JVM may implement references any way it likes,
...
```Java
String s1 = "Metropolia";
String s2 = "Metropolia";
```
and you want to compare wheter s1 is equal to s2, you may try this:
```Java
if (s1 == s2)
