...
Partly because of the above compilability, Java programs tend to be more efficient than Python programs (see the figure below). In addition, modern, large data centres consume a lot of energy and cloud computing software has grown in size. Therefore, the energy efficiency of software is, unsurprisingly, becoming increasingly important. The Java language is doing quite well in terms of energy efficiency.

![Energy Efficiency of various programming languages](./images/EnergyEfficiency.png)

Comparison of different programming languages, regarding energy efficiency, performance (Time) and program size (Mb), source [https://stratoflow.com/efficient-and-environment-friendly-programming-languages/](https://stratoflow.com/efficient-and-environment-friendly-programming-languages/).
