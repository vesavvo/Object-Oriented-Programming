...
When you ran the Hello World application, the Java compiler compiled the source code into [bytecode](https://medium.com/swlh/an-introduction-to-jvm-bytecode-5ef3165fae70), which was then executed by the JVM. The JVM is a virtual machine, which means that it is a software implementation of a computer that executes programs like a physical machine.
