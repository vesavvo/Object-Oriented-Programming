...
>Acronym JDK stands for Java Development Kit. It has roughly the same meaning as SDK, but is more specific to Java.
...
Install the environment, create a new project, and write a simple program that greets the user. Run the program and make sure that it works. Commit your changes to GitHub.
