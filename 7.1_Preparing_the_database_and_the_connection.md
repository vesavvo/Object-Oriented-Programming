...
>If you use a MacOS computer, you can use SequelAce as a database editor. You can download it from https://github.com/Sequel-Ace/Sequel-Ace or https://sequel-ace.com/. The course material has been written with HeidiSQL in mind, but all the same things can be done with SequelAce.
