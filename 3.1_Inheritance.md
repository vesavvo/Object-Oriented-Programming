...
- we look for a `toString` method in the class `Point3D`; this is not found, and we move to its parent class
...
- we look for a location method in the class `Point3D`; the method is found, and we execute its code
