...
We were using here lambda function for the event handler. We'll talk more about lambda functions [later](8.1_Lambda.md). For now, it is enough to know that the lambda function is a shorthand notation for writing an event handler.
