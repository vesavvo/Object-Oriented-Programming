...
- [Foundations of unit testing, running the tests, JavaDoc](8.1_UnitTesting.md)
- [TDD and unit test design](8.2_TDD.md)
- [Lambda statements](8.3_Lambda.md)
- [Map/filter/reduce](8.4_Functional.md)
